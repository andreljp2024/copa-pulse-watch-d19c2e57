...
REVOKE EXECUTE ON FUNCTION public.get_bolao_public_payment(text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_bolao_public_payment(text) TO anon, authenticated;
