...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "BolaoAI — Acompanhe a Copa do Mundo" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/src/assets/bolaoai-icon.png" },
      { rel: "apple-touch-icon", href: "/src/assets/bolaoai-icon.png" },
